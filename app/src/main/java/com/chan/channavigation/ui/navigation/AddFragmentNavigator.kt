 ...
 */
@Navigator.Name("add_fragment")
class AddFragmentNavigator(
    private val context: Context,
    private val fragmentManager: FragmentManager,
    private val containerId: Int
) : Navigator<AddFragmentNavigator.Destination>() {
    ...
    public constructor(fragmentNavigator: Navigator<out Destination>) :
        ...
        public constructor(navigatorProvider: NavigatorProvider) :
                this(navigatorProvider.getNavigator<AddFragmentNavigator>(AddFragmentNavigator::class.java))
